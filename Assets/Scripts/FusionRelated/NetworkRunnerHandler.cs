...
public class NetworkRunnerHandler : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    private void CustomStart()
    {
        ...
        if (SceneManager.GetActiveScene().name != "GameScene")
        {
            ...
            var clientTask = InitializeNetworkRunner(networkRunner, GameMode.AutoHostOrClient, "TestSession", SceneRef.FromIndex(SceneManager.GetActiveScene().buildIndex), NetAddress.Any(), null, 10);
    ...
    public void JoinGame(SessionInfo sessionInfo)
    {
        ...
        var clientTask = InitializeNetworkRunner(networkRunner, GameMode.Client, sessionInfo.Name, SceneRef.FromIndex(SceneManager.GetActiveScene().buildIndex), NetAddress.Any(), null, sessionInfo.MaxPlayers);
    }
