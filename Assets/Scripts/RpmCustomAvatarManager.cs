...
public class RpmCustomAvatarManager : NetworkBehaviour//, IAfterSpawned
{
    ...
    public void Init()
    {
        ...
        {
            networkCharacterController = mainParent.GetComponent<NetworkCharacterController>();
        }
    ...
    public void UpdateAnimator()
    {
        ...
        var isGrounded = networkCharacterController.Grounded;
        animator.SetFloat(MoveSpeedHash, playerCurrentMagnitude * networkCharacterController.maxSpeed);
    ...
    {
        jumpTrigger = false;
        if (networkCharacterController.Grounded)
        {
            jumpTrigger = true;
            networkCharacterController.Jump(false);
        }
        return jumpTrigger;
    }
