...
public class ThirdPersonLoader : MonoBehaviour
{
    ...
    private void SetupAvatar(GameObject  targetAvatar)
    {
        ...
        MyAvatarCreatorData avatarData = new MyAvatarCreatorData();
       // https://models.readyplayer.me/63e9b2126f759e4d1dfabc6d.glb 
        avatarData.Id = avatarUrl.Split('/')[3].Split('.')[0];        
        FetchAvatarSavedInformation.SaveAvatarInformationLocally(avatarData);
    }
